...
**Status:** ✅ PRODUCCIÓN OPERATIVA (servidor your-homelab-ip)
...
6. ✅ Desplegar a servidor homelab (your-homelab-ip)
...
**Usuario:** dockerja  
**Comando conexión:** `ssh dockerja@your-homelab-ip`
...
- [ ] Conectar a servidor: `ssh dockerja@your-homelab-ip`

...
|---|---|---|
| **Servidor (192.168.24.103)** | ✅ ONLINE | 5/5 procesos PM2 corriendo |
...
```bash
# ✅ Servidor producción (192.168.24.103)
sssh dockerja@192.168.24.103
...
**Servidor**: 192.168.24.103 (dockerja)  
...
*[Hub personal](https://joseangelhub.miniserver.online/) · [GitHub](https://github.com/joseangelalejo) · [Documentación](https://joseangelalejo.github.io/yukiko/) · [Estado en vivo](https://192.168.24.103:3000)*

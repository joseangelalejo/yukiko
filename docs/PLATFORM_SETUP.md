...
# Probar conexión:
ssh -i ~/.ssh/id_ed25519_github dockerja@100.66.214.108
...
ssh -i ~/.ssh/id_ed25519_github dockerja@100.66.214.108 \
  "cd /home/dockerja/docker-compose-files/yukiko && git pull origin main && npm install && pm2 restart all && pm2 save"
...
| `HOMELAB_PATH` | Ruta del bot (`/home/dockerja/docker-compose-files/yukiko`) |

...
NEXTAUTH_URL=https://yukiko.miniserver.online
NEXT_PUBLIC_APP_URL=https://yukiko.miniserver.online
...
En Vercel → Settings → Domains → añade `yukiko.miniserver.online`
...
server {
    listen 80;
    server_name yukiko.miniserver.online;
...
| `HOMELAB_PATH` | `/home/dockerja/docker-compose-files/yukiko` |

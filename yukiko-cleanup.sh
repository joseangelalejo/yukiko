...
path = 'your-home-path/yukiko/docker-compose.yml'
with open(path) as f:
    content = f.read()
...
path = 'your-home-path/yukiko/tsconfig.json'
with open(path) as f:
    content = f.read()
...
python3 << 'PYEOF'
path = 'your-home-path/yukiko/ssh-cli/yukiko.ts'
with open(path) as f:
    content = f.read()
...
python3 << 'PYEOF'
path = 'your-home-path/yukiko/db/schema.ts'
with open(path) as f:
    content = f.read()
